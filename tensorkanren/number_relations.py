        ...
        def goal(sub: Substitution):
            ...
            if not isvar(arg1):
                if not isvar(arg2):  # const, const
                    rel_tensor = tf.array(False, tf.bool)
                ...
                if not isvar(arg2):  # var, const
                    ...
                    rel_tensor = tf.tri(arg1.type.size(), arg2.type.size(), 1-self.i, tf.bool)  # places a1 > a2
    ...
    def goal(sub: Substitution):
        ...
        if not isvar(arg1):
            ...
            if not isvar(arg2): # var, const
                ...
                assert(arg1.type == arg2.type)
                rel_tensor = tf.tri(arg1.type.size(), arg2.type.size(), 1, tf.bool) # places a1 > a2
                return sub.unify(rel_tensor, arg1, arg2)
    ...
    def goal(sub: Substitution):
        ...
        if not isvar(arg1):
            ...
            if not isvar(arg2): # var, const
                ...
                assert(arg1.type == arg2.type)
                rel_tensor = tf.tri(arg1.type.size(), arg2.type.size(), 0, tf.bool).T # places a1 < a2
                return sub.unify(rel_tensor, arg1, arg2)
